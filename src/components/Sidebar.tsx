          ...
          >
            ...
            <div className="flex items-center justify-between pb-4">
              <div className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-neutral-900 border border-neutral-800 text-neutral-100 overflow-hidden shrink-0">
                  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6">
                    <defs>
                      <radialGradient id="centralGlowSidebar" cx="50%" cy="50%" r="50%">
                        <stop offset="0%" stopColor="#FF7300" stopOpacity="1" />
                        <stop offset="50%" stopColor="#FF5500" stopOpacity="0.4" />
                        <stop offset="100%" stopColor="#FF5500" stopOpacity="0" />
                      </radialGradient>
                      <linearGradient id="traceGradSidebar" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stopColor="#FF7300" stopOpacity="0.8" />
                        <stop offset="100%" stopColor="#FF5500" stopOpacity="0.3" />
                      </linearGradient>
                    </defs>
                    <circle cx="50" cy="50" r="28" fill="url(#centralGlowSidebar)" opacity="0.45" />
                    <g stroke="url(#traceGradSidebar)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.75">
                      <path d="M 50 38 V 15" />
                ...
                <span className="font-semibold text-neutral-100 tracking-tight">PocketCodex</span>
              </div>
              <button
                onClick={onClose}
